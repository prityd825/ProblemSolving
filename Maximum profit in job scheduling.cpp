...
// recursive solution with memoization (dynamic programming) for solving the "Job Scheduling with Maximum Profit" problem. The problem is a variation of the classic job scheduling problem.
//Course name: data structure and algorithm [Topic: Dynamic programming (2.1)]
